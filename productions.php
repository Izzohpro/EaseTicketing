...
?>
<span style="font-size:40px; font-weight:300; color:#fff; position: center"><?php echo $var; ?></span><br><br>
...
<div class="thumbnail"> 
		<center>
                <a href="./performances.php?id=<?php echo $f['productionid'] ?>&name=<?php echo $f['productionname']?>"><img src="<?php echo $f['productionimage'];?>" style="width:40%; height:50%; margin-bottom:5px"></a>
