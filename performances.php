...
if (isset($_GET['id'])){
	...
	?><h1  style="color:#fff"><?php echo$_GET['name']; ?></h1>
	<span style="font-size:30px; font-weight:200; color: #fff; padding-left:20px"><b><center>Performances</center></b></span><br><br> 
