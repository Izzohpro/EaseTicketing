...
<body>
    <div class="container">
    		<div class="row"><br>
    			<h1  style="color:#fff; font-weight:200"><center>Production CRUD</center></h1><br>
				<center><a href="../index.php"  style="font-weight:400; color:#fff"><strong>Home Page</strong></a></center>
    		</div>
			<div class="row">
				<p>
