...
if ( isset($_SESSION['basket']) && isset ($_SESSION['customer']) ){
	...
	if($count){
		...
		<span style="font-size:23px; font-weight:400; color:white">Your tickets have been successfully booked! <br>Now you can collect them at the theatre showing your ticket ID. An email has been also sent to you with the details of your purchase.<br>THANK YOU!<br><br></span>
		</div><?php
